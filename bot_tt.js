...
await sock.sendMessage(grupo,{image:{url:d.imageHD||d.image},caption:'╭━━━━━━━━━━━━━━━⊷\n┃ 🎵 *SPOTIFY*\n╰━━━━━━━━━━━━━━━⬣\n\n🎵 '+d.name+'\n👤 '+d.artist+'\n💿 '+d.album});
await sock.sendMessage(grupo,{audio:{url:d.url},mimetype:'audio/mpeg',fileName:d.name+'.mp3'});
...
if(cmd===PREFIX+'ruleta'){if(!d.ruleta)return await sock.sendMessage(grupo,{text:'╭━━━━━━━━━━━━━━━⊷\n┃ 🔫 *RULETA RUSA*\n╰━━━━━━━━━━━━━━━⬣\n\n💡 /ruletacrear - Crear\n💡 /ruletaunirse - Unirse\n💡 /ruletainiciar - Iniciar'});if(d.ruleta.activo)return await sock.sendMessage(grupo,{text:'🔫 Ruleta en curso'});}
if(cmd===PREFIX+'ruletacrear'){if(d.ruleta)return await sock.sendMessage(grupo,{text:'🔫 Ya hay partida'});d.ruleta={jugadores:[sender],dueno:sender,iniciada:false,activo:false};setDB(grupo,d);await sock.sendMessage(grupo,{text:'╭━━━━━━━━━━━━━━━⊷\n┃ 🔫 *RULETA CREADA*\n╰━━━━━━━━━━━━━━━⬣\n\n👤 Creador\n👥 1/5\n💡 /ruletaunirse'});return;}
if(cmd===PREFIX+'ruletaunirse'){if(!d.ruleta||d.ruleta.iniciada||d.ruleta.activo)return;if(d.ruleta.jugadores.includes(sender))return await sock.sendMessage(grupo,{text:'🔫 Ya estás'});if(d.ruleta.jugadores.length>=5)return await sock.sendMessage(grupo,{text:'🔫 Llena'});d.ruleta.jugadores.push(sender);setDB(grupo,d);await sock.sendMessage(grupo,{text:'╭━━━━━━━━━━━━━━━⊷\n┃ 🔫 *RULETA*\n╰━━━━━━━━━━━━━━━⬣\n\n✅ @'+sender.split('@')[0]+' se unió\n👥 '+d.ruleta.jugadores.length+'/5',mentions:[sender]});return;}
if(cmd===PREFIX+'ruletainiciar'){if(!d.ruleta||d.ruleta.iniciada||d.ruleta.activo)return;if(d.ruleta.dueno!==sender)return await sock.sendMessage(grupo,{text:'❌ Solo el dueño'});if(d.ruleta.jugadores.length<2)return await sock.sendMessage(grupo,{text:'❌ Mínimo 2'});d.ruleta.iniciada=true;d.ruleta.activo=true;setDB(grupo,d);await sock.sendMessage(grupo,{text:'╭━━━━━━━━━━━━━━━⊷\n┃ 🔫 *¡RULETA INICIADA!*\n╰━━━━━━━━━━━━━━━⬣\n\n👥 '+d.ruleta.jugadores.length+' jugadores'});dispararRuleta(sock,grupo,d);return;}
}
...
if(cmd===PREFIX+'setwelcome'){const msg=texto.slice(12);if(!msg)return await sock.sendMessage(grupo,{text:'❌ Escribe el mensaje'});d.welcomeMsg=msg;setDB(grupo,d);await sock.sendMessage(grupo,{text:'╭━━━━━━━━━━━━━━━⊷\n┃ ✅ *BIENVENIDA*\n╰━━━━━━━━━━━━━━━⬣\n\n✅ Personalizada\n💡 /welcomepredeterminado para restaurar'});}
if(cmd===PREFIX+'setdespedida'){const msg=texto.slice(14);if(!msg)return await sock.sendMessage(grupo,{text:'❌ Escribe el mensaje'});d.despedidaMsg=msg;setDB(grupo,d);await sock.sendMessage(grupo,{text:'╭━━━━━━━━━━━━━━━⊷\n┃ ✅ *DESPEDIDA*\n╰━━━━━━━━━━━━━━━⬣\n\n✅ Personalizada\n💡 /despedidapredeterminada para restaurar'});}
